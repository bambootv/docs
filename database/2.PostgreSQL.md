...
✅ 1. Tạo user read-only
CREATE USER readonly_user WITH PASSWORD 'your_password';

✅ 2. Cấp quyền CONNECT vào database
GRANT CONNECT ON DATABASE your_database TO readonly_user;

✅ 3. Cấp quyền USAGE trên schema

(PostgreSQL mặc định dùng schema public)

GRANT USAGE ON SCHEMA public TO readonly_user;

✅ 4. Cấp quyền SELECT trên tất cả bảng hiện có
GRANT SELECT ON ALL TABLES IN SCHEMA public TO readonly_user;

✅ 5. Cấp quyền SELECT cho tất cả bảng tạo trong tương lai
...
🔐 6. Cấp quyền đọc SEQUENCES (nếu bảng có SERIAL / IDENTITY)

Một số ORM hoặc query đọc ID cần quyền đọc sequence.
...
🚫 7. (Tuỳ chọn) Ngăn user tạo bảng, insert, update, delete
